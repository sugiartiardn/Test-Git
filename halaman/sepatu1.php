    ...
    <body>
        <div>
            ...
            <table>
                    ...
                    <tr>
                        <td>
                            <img src="gambar/sepatu1.jpg" width="300">
                        </td>
                        <td>
                            <p>
                                Big Sale Sepatu Slip On Wanita S08 Model Tali <br>
                                <img src="gambar/batas.jpg"><br>
                                <font color="#999999" size="3">Pengiriman dari jakarta - Gratis Ongkir</font><br><br><br>
                                <font color="coral">Rp.120.000</font>
                            </p>
                        </td>
                        <td>
                            <a href="index.php">
                                <img src="gambar/keluar.jpg" width="150" class="poto"> 
                            </a>
                            <a href="beli.php">
                                <img src="gambar/beli.jpg" width="150"> 
                            </a>
                        </td>
                    </tr>
                </table><br>
